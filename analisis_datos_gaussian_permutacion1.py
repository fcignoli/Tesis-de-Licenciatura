...
###########################################################################################################lases_train_tod
ubicacion_del_archivo='/home/felipe/Documentos/tesis/corridas/entrenamiento2_combinacion3'
...
for k in dimensiones:
    ...
    for _ in range(num):
            ...
            salida= k
            pesos='/home/felipe/Documentos/tesis/permutacion1_modelo' + str(k) +'d_tamaños_ajustados.h5'
