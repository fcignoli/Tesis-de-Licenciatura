...
for k in dimensiones:
    ...
    for _ in range(num):
            ...
            ###########################################################################################################
            #clusteriamos
            X1 = lista_coordenadas
            cluster_coordenadas = MeanShift(bandwidth=3).fit(X1)
            #print('etiquetas de clustering',kmeans_coordenadas.labels_)
            #print('etiquetas de reales',lista_clases)
            #X2 = lista_coordenadas_val
            #cluster_coordenadas_val = MeanShift(bandwidth=2).fit(X2)
            #print('etiquetas de clustering',kmeans_coordenadas_val.labels_)
            #print('etiquetas de reales',lista_clases_val)
            
            clases_train = cluster_coordenadas.labels_ == lista_clases
            ...
            #clases_val = cluster_coordenadas_val.labels_ == lista_clases_val
