...
###########################################################################################################lases_train_tod
ubicacion_del_archivo='/home/felipe/Documentos/tesis/corridas/entrenamiento3_combinacion2'
...
for k in dimensiones:
    ...
    for _ in range(num):
            ...
            salida= k
            pesos='/home/felipe/Documentos/tesis/permutacion2_modelo' + str(k) +'d_tamaños_ajustados.h5'
